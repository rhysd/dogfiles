 ...
 * `--------+------+------+------+-------+---------------'           `----------------+-------+------+------+------+--------'
 *   |Media |      |      | LAlt |LG/Eisu|                                            |RG/Kana| RAlt |   [  |   ]  | ~L1  |
 *   `-----------------------------------'                                            `-----------------------------------'
 *                                       ,---------------.           ,---------------.
 *                                       |LGuiEnt|LGuiTab|           |AltTab|Ctrl/Esc|
 *                                ,------|-------|-------|           |------+--------+--------.
 *                                |      |       | Home  |           | PgUp |        |        |
 *                                |Ctrl/ |OneShot|-------|           |------|BackSpc |RShift/ |
 *                                |Space |L1     | End   |           | PgDn |        |Enter   |
 *                                `----------------------'           `----------------------'
 */
...
[SYMB] = KEYMAP(
       ...
       // right hand
       KC_TRNS, KC_TRNS, KC_TRNS,KC_MINS, KC_EQL,  KC_BSLS, KC_QUOT,
